    ...
    "json_schema" => [
        "schema" => [
            ...
            "properties" => [
                ...
                "contact" => [
                    "description" => "Coordonnées personnelles extraites du document. Ne jamais inventer ni compléter ces données si elles ne sont pas clairement présentes.",
                    "type" => "object",
                    "properties" => [
                        "email" => [
                ...
                "situation_professionnelle" => [
                    ...
                    "properties" => [
                        ...
                        "disponibilites" => [
                            ...
                            "properties" => [
                                "date_debut" => [
                                    "description" => "Date de début de disponibilité (formats acceptés : dd/mm/yyyy, mm/yyyy, yyyy).",
                                    "type" => "string",
                                ],
                                "date_fin" => [
                                    "description" => "Date de fin de disponibilité (formats acceptés). La date doit toujours apparaître sous le format suivant : jj/mm/année, si le jour n'est pas spécifié, la date doit être écrite dans ce format : mm/année. Si seulement l'année apparaît écrit uniquement l'année.",
                                    "type" => "string"
                                ]
                            ],
                            "additionalProperties" => false
                ...
                "competences" => [
                    ...
                    "properties" => [
                        "techniques" => [
                            "description" => "Compétences métiers techniques (ex. épilation, soins du corps, massage). N'hésite pas à récupérer les descriptions des compétences si elles sont notées.",
                            "type" => "array",
                            "items" => ["type" => "string"],
                        ],
                        "logiciels_outils" => [
                ...
                "motivation" => [
                    "description" => "Identifie et extrais toutes les phrases exprimant explicitement l’intérêt pour le métier, les objectifs professionnels, des slogans, des phrases de dévouement pour son travail et les formules de politesse. Recopie bien toute la/les phrases présente(s). Rassemble ces phrases dans un tableau « motivation » du JSON, sans doublons et sans inventer ou compléter ce qui n’est pas explicitement présent.",
                    "type" => "array",
                    "items" => ["type" => "string"]
                ],
                "experiences" => [
                    ...
                    "items" => [
                        ...
                        "properties" => [
                            ...
                            "date_debut" => [
                                "description" => "Date de début (même si placée au-dessus ou éloignée du titre). La date doit toujours apparaître sous le format suivant : jj/mm/année, si le jour n'est pas spécifié, la date doit être écrite dans ce format : mm/année. Si seulement l'année apparaît écrit uniquement l'année.",
                                "type" => "string",
                            ],
                            "date_fin" => [
                                "description" => "Date de début (même si placée au-dessus ou éloignée du titre). La date doit toujours apparaître sous le format suivant : jj/mm/année, si le jour n'est pas spécifié, la date doit être écrite dans ce format : mm/année. Si seulement l'année apparaît écrit uniquement l'année. Il peut ne pas y avoir de date, mais un ou des mot(s) permettant d'identifier si le poste est toujours d'actualité (maintenant, actuellement, en cours,...).",
                                "type" => "string",
                            ],
                            "duree" => [
                            ...
                            "type_contrat" => [
                                ...
                                "description" => "Identifie  les types de contrats (CDI, CDD, intérim, stage, etc,...), ils peuvent être à côté de la durée, du nom de l'entreprise, de l'année d'exercice, des activitées. Dès qu'il y a un nom de contrat donné inscrit-le dans le champ.",
                                "type" => "string"
                            ],
                            "description" => [
                                "description" => "Description du rôle et des activités.",
                                "type" => "string",
                            ],
                            "activites" => [
                                "description" => "Liste des tâches ou activités réalisées.",
                                "type" => "array",
                                "items" => ["type" => "string"]
                            ]
                        ],
                ...
                "formations" => [
                    ...
                    "items" => [
                        ...
                        "properties" => [
                            ...
                            "date_fin" => [
                                "description" => "Date de fin (même si placée au-dessus ou éloignée du titre). La date doit toujours apparaître sous le format suivant : jj/mm/année, si le jour n'est pas spécifié, la date doit être écrite dans ce format : mm/année. Si seulement l'année apparaît écrit uniquement l'année.",
                                "type" => "string",
                            ],
                            "duree" => [
                                "description" => "Durée explicitement indiquée (ex. '2 ans').",
                                "type" => "string",
                            ],
                            "option" => [
                ...
                "langues" => [
                    ...
                    "items" => [
                        ...
                        "properties" => [
                            ...
                            "niveau_original" => [
                                "description" => "Niveau tel qu’écrit dans le CV (ex : bilingue, A2, 4/5). N’inclus jamais de symboles seuls (☑, ★, ●, ○, etc.). Le niveau doit obligatoirement être écrit avec des lettres, chiffres ou mots. Si aucun texte n’est écrit, ne renseigne pas ce champ.",
                                "type" => "string",
                            ],
