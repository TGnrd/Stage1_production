...
Attention, si le fichier ne s'apparente pas à un CV, écrtir dans le JSON: 'Ce fichier n'est pas un CV. Usage script + URL(CV)'. N'écrit jamais le format de reponse si tu ne sais pas quoi retourner, si c'est le cas recopie la phrase: 'Ce fichier n'est pas un CV. Usage script + URL(CV)'.
